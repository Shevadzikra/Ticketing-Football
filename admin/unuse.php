...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // [Kode CRUD yang sama seperti sebelumnya]
}
...
// Get upcoming matches with sold out tickets
...
<html lang="en">
<head>
    <!-- [Head section yang sama seperti sebelumnya] -->
</head>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="<?= $is_past ? 'bg-yellow-50' : '' ?>">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <a href="mark_completed.php?id=<?= $match['id'] ?>" 
                                       class="text-green-600 hover:text-green-900 ml-3"
                                       onclick="return confirm('Tandai pertandingan ini sebagai selesai?')">
                                        <i class="fas fa-check"></i>
                                    </a>
                                    <a href="add_tickets.php?match_id=<?= $match['id'] ?>" 
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <a href="mark_uncompleted.php?id=<?= $match['id'] ?>" 
